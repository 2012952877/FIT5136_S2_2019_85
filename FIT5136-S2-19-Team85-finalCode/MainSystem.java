...
public class MainSystem
{
    ...
    public String login()
    {
        ...
        if(userExist)
        {
            ...
            str = type.get(index) + "," + email.get(index);
        }
        else
        {
            ...
            if(type.equals("1"))
            {
                ...
                while (login)
                {
                    if(user[0].equals("Customer"))
                    {
                        ...
                        {
                            System.out.println("Sorry, please enter value between 1, 2, 3, 4");
                            type = scan.nextLine().trim();
                        }
                        ...
                        switch(type)
                        {
                            ...
                            scan.nextLine();
                            break;
                            case "2": Customer c1 = new Customer();
                            c1.searchHall();
                            break;
                            case "3": Customer c2 = new Customer();
                            c2.setEmail(user[1]);
                            c2.bookHall(user[1]);
                            break;
                            default:
                            System.out.println("Sorry, this functiuon has not been developed.");
                            scan.nextLine();
                            break;
                        }
                    }
                    ...
                    else
                    {
                        ...
                        switch(type)
                        {
                            ...
                            scan.nextLine();
                            break;
                            case "2": Owner o1 = new Owner();
                            o1.createHall(user[1]);
                            break;
                            case "3": Owner o2 = new Owner();
                            o2.setEmail(user[1]);
                            o2.viewHall(user[1]);
                            break;
                            default:
